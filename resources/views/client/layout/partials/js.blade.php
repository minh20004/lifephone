...
{{-- thay đổi màu sắc của chi tiết sanmr phẩm --}}
<script>
        ...
        const variants = @json($variants);
            document.addEventListener('DOMContentLoaded', function () {
                  ...
                  function formatPrice(price) {
                      return price.toLocaleString('vi-VN', { minimumFractionDigits: 0, maximumFractionDigits: 0 }) + ' đ';
                  }
                  ...
                  function updatePrice() {
                      ...
                      if (selectedCapacity && selectedColor) {
                          ...
                          if (selectedVariant) {
                              ...
                              basePriceElement.textContent = formatPrice(Number(basePriceElement.getAttribute('data-base-price')));
                          }
                      }
                  }
