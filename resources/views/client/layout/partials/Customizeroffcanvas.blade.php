{{-- <div class="offcanvas offcanvas-end" id="customizer" tabindex="-1">
    ...
    <div class="offcanvas-body">
      ...
      <div class="customizer-collapse collapse" id="customizerCode">
        ...
        <p class="fs-sm pb-1">To apply the provided styles to your webpage, enclose them within a <code>&lt;style&gt;</code> tag and insert this tag into the <code>&lt;head&gt;</code> section of your HTML document after the following link to the main stylesheet:<br><code>&lt;link href="client/css/theme.min.css"&gt;</code></p>
