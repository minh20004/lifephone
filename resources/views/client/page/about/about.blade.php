...
<!-- Mirrored from cartzilla.createx.studio/about-v1.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 06 Sep 2024 06:30:01 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=utf-8" /><!-- /Added by HTTrack -->
<head>
    <title>Cartzilla | About</title>
    <meta charset="utf-8">
    <!-- Viewport -->
    ...
    <main class="content-wrapper">
        ...
        <div class="row">
          ...
          <div class="col-md-7 order-md-2 mb-4 mb-md-0">
            <div class="position-relative h-100">
              ...
              <img src="{{ asset('client/img/about/v1/hero.jpg') }}" class="position-absolute top-0 start-0 w-100 h-100 object-fit-cover rounded-5" alt="Image">
            </div>
          </div>
      ...
      <section class="container pt-3 pt-sm-4 pt-lg-5 mt-lg-2 mt-xl-4 mt-xxl-5" id="mission" style="scroll-margin-top: 60px">
        <div class="text-center mx-auto" style="max-width: 690px">
          ...
          <img src="{{ asset('client/img/about/v1/avatar.jpg') }}" width="64" class="d-block rounded-circle mx-auto mb-3" alt="Avatar">
        ...
        <div class="row pt-2 pt-sm-3 pt-md-4 pt-lg-5">
          <div class="col-md-5 col-lg-6 pb-1 pb-sm-2 pb-md-0 mb-4 mb-md-0">
            <div class="ratio ratio-1x1">
              <img src="{{ asset('client/img/about/v1/delivery.jpg') }}" class="rounded-5" alt="Image">
            </div>
          </div>
      ...
      <section class="container pt-5 mt-2 mt-sm-3 mt-md-4 mt-lg-5">
        <div class="row row-cols-1 row-cols-md-2 g-4">
          <div class="col">
            <div class="position-relative h-100">
              <div class="ratio ratio-16x9"></div>
              <img src="{{ asset('client/img/about/v1/video-cover.jpg') }}" class="position-absolute top-0 start-0 w-100 h-100 object-fit-cover rounded-5" alt="Image">
...
<!-- Mirrored from cartzilla.createx.studio/about-v1.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 06 Sep 2024 06:30:03 GMT -->
</html>