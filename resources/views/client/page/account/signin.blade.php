...
<!-- Mirrored from cartzilla.createx.studio/account-signin.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 06 Sep 2024 06:29:48 GMT -->
<!-- Added by HTTrack -->
...
<head>
    ...
    <link rel="icon" type="image/png" href="{{ asset('client/template') }}/assets/app-icons/icon-32x32.png"
        sizes="32x32">
    <link rel="apple-touch-icon" href="{{ asset('client/template') }}/assets/app-icons/icon-180x180.png">

    <!-- Theme switcher (color modes) -->
    <script src="{{ asset('client/template') }}/assets/js/theme-switcher.js"></script>

    <!-- Preloaded local web font (Inter) -->
    <link rel="preload" href="{{ asset('client/template') }}/assets/fonts/inter-variable-latin.woff2" as="font"
        type="font/woff2" crossorigin="">

    <!-- Font icons -->
    <link rel="preload" href="{{ asset('client/template') }}/assets/icons/cartzilla-icons.woff2" as="font"
        type="font/woff2" crossorigin="">
    ...
    <!-- Customizer -->
    <script src="{{ asset('client/template') }}/assets/js/customizer.min.js"></script>
</head>
...
<body>
            ...
            <div class="customizer-collapse collapse" id="customizerCode">
                ...
                <p class="fs-sm pb-1">To apply the provided styles to your webpage, enclose them within a
                    ...
                    your HTML document after the following link to the main stylesheet:<br><code>&lt;link
                        href="{{ asset('client/template') }}/assets/css/theme.min.css"&gt;</code>
                </p>
        ...
        <div class="d-lg-flex">
            ...
            <div class="d-flex flex-column min-vh-100 w-100 py-4 mx-auto me-lg-5" style="max-width: 416px">
                ...
                <div class="nav fs-sm mb-4">
                    ...
                    <a class="nav-link text-decoration-underline p-0 ms-2" href="{{ route('signup') }}">Create an
                        account</a>
                </div>
    ...
    <script src="{{ asset('client/template') }}/assets/js/theme.min.js"></script>


</body>
<!-- Mirrored from cartzilla.createx.studio/account-signin.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 06 Sep 2024 06:29:49 GMT -->
