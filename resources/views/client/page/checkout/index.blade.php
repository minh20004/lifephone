              ...
              <div class="w-100 ps-3 ps-md-4">
                ...
                <form class="needs-validation" novalidate="">
                  <div class="row row-cols-1 row-cols-sm-2 g-3 g-sm-4 mb-4">
                    <div class="col">
                      <label for="shipping-fn" class="form-label">Họ và tên <span class="text-danger">*</span></label>
              ...
              <div class="p-sm-2 p-lg-0 p-xl-2">
                ...
                <ul class="list-unstyled fs-sm gap-3 mb-0">
                  <li class="d-flex justify-content-between">
                    ...
                    <span class="text-dark-emphasis fw-medium">24.000.000 đ</span>
                  </li>
                  <li class="d-flex justify-content-between">
                    Giảm giá:
                    <span class="text-danger fw-medium">240.000 đ</span>
                  </li>
                  <li class="d-flex justify-content-between">
                    Vận chuyển:
                ...
                <div class="border-top pt-4 mt-4">
                  <div class="d-flex justify-content-between mb-3">
                    ...
                    <span class="h5 mb-0">23.795.000 đ</span>
                  </div>
                </div>
              </div>
            </div>
