            ...
            <li class="nav-item">
                ...
                <div class="collapse menu-dropdown" id="sidebarDashboards">
                    <ul class="nav nav-sm flex-column">
                        <li class="nav-item">
                            <a href="{{ route('user.home') }}" class="nav-link" data-key="t-analytics"> Xem trang </a>
                        </li>
                        <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('vouchers.index') }}" class="nav-link" data-key="t-job">Job</a>
                        </li>
                    </ul>
                </div>
            ...
            <li class="nav-item">
                ...
                <div class="collapse menu-dropdown" id="sidebarAuth">
                    <ul class="nav nav-sm flex-column">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('admin.thanh-vien') }}" class="nav-link" data-key="t-signin"> 
                                Tất cả người dùng
                            </a>
                        </li>
                        <li class="nav-item">
