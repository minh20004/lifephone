...
<div id="scrollbar">
  <div class="container-fluid">
    ...
    <ul class="navbar-nav" id="navbar-nav">
      ...
      <li class="nav-item">
                <a class="nav-link menu-link" href="#sidebarPages5" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarPages1">
                    <i class="ri-pages-line"></i> <span data-key="t-pages">Quản lý bình luận</span>
                </a>
                <div class="collapse menu-dropdown" id="sidebarPages5">
                    <ul class="nav nav-sm flex-column">
                        <li class="nav-item">
                            <a href="{{route('reviews_admin.index')}}" class="nav-link" data-key="t-starter"> Danh mục bình luận </a>
                        </li>
                    </ul>
                </div>
            </li>
