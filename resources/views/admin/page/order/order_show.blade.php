                ...
                <div class="card-body">
                    <div class="align-items-center ">
                        ...
                        <div class="d-flex align-items-center border-bottom pt-2 pb-2">
                            <div class="col-md-1">
                            @if (!empty($item->image_url))  <!-- Kiểm tra nếu image_url không rỗng hoặc null -->
                                <img src="{{ asset('storage/' . $item->image_url) }}" width="100px" alt="Product" class="img-fluid rounded">
                            @else
                                Không có ảnh
                            @endif
                            </div>
