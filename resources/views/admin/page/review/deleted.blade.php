    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between bg-galaxy-transparent">
                <h4 class="mb-sm-0">Danh sách Review đã bị xóa mềm</h4>
            </div>
        </div>
    </div>
                                            ...
                                            <div class="gridjs-wrapper" style="height: auto;">
                                                <table role="grid" class="gridjs-table" style="height: auto;">
                                                    <thead class="gridjs-thead">
                                                        <tr class="gridjs-tr">
                                                            ...
                                                            <th data-column-id="action" class="gridjs-th gridjs-th-sort text-muted" tabindex="0" style="width: 140px;">
                                                                <div class="gridjs-th-content">Ngày Xóa</div>
                                                    ...
                                                    <tbody class="gridjs-tbody">
                                                        @foreach ($deletedReviews as $key => $review)
                                                        <tr class="gridjs-tr">
