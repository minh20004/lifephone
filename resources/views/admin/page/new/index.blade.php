            ...
            <div class="col-xl-12 col-lg-8">
                <div class="card">
                    ...
                    <div class="card-header">
                        <div class="row align-items-center">
                            <div class="col-md-6">
                                <form action="{{ route('new_admin.index') }}" method="GET" class="d-flex">
                                    <input type="text" name="search" class="form-control me-2" placeholder="Tìm kiếm theo tiêu đề..." value="{{ request('search') }}">
