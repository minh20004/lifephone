...
@endif
            ...
            <div class="card ">
                ...
                <div class="card-body">
                    ...
                    {{-- form này báo lỗi sẽ mất những cái đã điền --}}
                    ...
                    <form action="{{ route('product-admin.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="form-group col-md-4 mb-3">
                                <label for="product_code" class="form-label text-dark fw-bold fs-5">Mã sản phẩm</label>
                                <input type="text" class="form-control @error('product_code') is-invalid @enderror"
                                    id="product_code" name="product_code" placeholder="Nhập mã sản phẩm" value="{{ old('product_code') }}">
                                @error('product_code')
                                    <div class="invalid-feedback text-danger">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="form-group col-md-4 mb-3">
                                <label for="name" class="form-label text-dark fw-bold fs-5">Tên sản phẩm</label>
                                <input type="text" class="form-control @error('name') is-invalid @enderror"
                                    id="name" name="name" placeholder="Nhập tên sản phẩm" value="{{ old('name') }}">
                                @error('name')
                                    <div class="invalid-feedback text-danger">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="mb-3 mt-3">
                                ...
                                <div id="thumbbox" style="margin-top: 10px;">
                                    ...
                                    <a class="removeimg" href="javascript:void(0);" onclick="removeImage()" style="display: none; color:red">Xóa ảnh</a>
                                    @error('image_url')
                                        <div class="invalid-feedback text-danger">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class="mb-3 mt-3">
                                ...
                                <input type="file" id="gallery_image" name="gallery_image[]" multiple accept="image/*"
                                    class="form-control d-none @error('gallery_image.*') is-invalid @enderror" onchange="previewImages(event)" />
                                @error('gallery_image.*')
                                    <div class="invalid-feedback text-danger">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="mb-5">
                                <label for="description" class="form-label text-dark fw-bold fs-5">Mô tả sản phẩm:</label>
                                <textarea class="form-control @error('description') is-invalid @enderror" id="description" name="description" cols="500" rows="10" placeholder="Mô tả sản phẩm">{{ old('description') }}</textarea>
                                @error('description')
                                    <div class="invalid-feedback text-danger">
                                        {{ $message }}
                                    </div>
