        ...
        <div class="container-fluid">
            <div class="card">
                <h2 class=" text-dark fw-bold m-3 mt-4 "
                    ...
                    Sửa dung lượng sản phẩm</h2>
                <div class="card-body">
                    <form action="{{ route('capacity.update', $capacity->id) }}" method="POST" enctype="multipart/form-data">
                        @method('Put')
                        @csrf
                        <div class="mb-3">
                            <label for="" class="form-label text-dark fw-bold fs-5">Tên dung lượng</label>
                            <input type="text" class="form-control @error('name') is-invalid @enderror" name="name" placeholder="Nhập tên dung lượng" value="{{ $capacity->name}}">
