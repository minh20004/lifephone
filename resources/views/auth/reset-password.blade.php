...
<!-- Mirrored from cartzilla.createx.studio/account-signup.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 06 Sep 2024 06:29:49 GMT -->
        ...
        <div class="d-flex flex-column min-vh-100 w-100 py-4 mx-auto me-lg-5" style="max-width: 416px">
          ...
          @if (session('msg'))
                    <div class="alert alert-success">
                        <strong>{{session('msg')}} - Vui lòng <a class="btn btn-primary" href="{{ route('login') }}">Đăng nhập</a></strong>
                    </div>
                @endif
