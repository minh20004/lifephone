...
<!-- Mirrored from cartzilla.createx.studio/account-password-recovery.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 06 Sep 2024 06:29:49 GMT -->
...
<head>
    ...
    <link rel="manifest" href="{{ asset('client/template') }}/manifest.json">
    <link rel="icon" type="image/png" href="{{ asset('client/template') }}/assets/app-icons/icon-32x32.png" sizes="32x32">
    <link rel="apple-touch-icon" href="{{ asset('client/template') }}/assets/app-icons/icon-180x180.png">

    <!-- Theme switcher (color modes) -->
    <script src="assets/js/theme-switcher.js"></script>

    <!-- Preloaded local web font (Inter) -->
    <link rel="preload" href="{{ asset('client/template') }}/assets/fonts/inter-variable-latin.woff2" as="font" type="font/woff2" crossorigin="">

    <!-- Font icons -->
    <link rel="preload" href="{{ asset('client/template') }}/assets/icons/cartzilla-icons.woff2" as="font" type="font/woff2" crossorigin="">
    <link rel="stylesheet" href="{{ asset('client/template') }}/assets/icons/cartzilla-icons.min.css">

    <!-- Bootstrap + Theme styles -->
    <link rel="preload" href="{{ asset('client/template') }}/assets/css/theme.min.css" as="style">
    <link rel="preload" href="{{ asset('client/template') }}/assets/css/theme.rtl.min.css" as="style">
    <link rel="stylesheet" href="{{ asset('client/template') }}/assets/css/theme.min.css" id="theme-styles">
  ...
  <body>
    ...
    <div class="offcanvas offcanvas-end" id="customizer" tabindex="-1">
      ...
      <div class="offcanvas-body">
        ...
        <div class="customizer-collapse collapse" id="customizerCode">
          <div class="nav mb-3">
            <a class="nav-link animate-underline fs-base p-0" href="{{ asset('client/template') }}/.html" data-bs-toggle="collapse" aria-expanded="true" aria-controls="customizerSettings customizerCode">
              <i class="ci-chevron-left fs-lg ms-n1 me-1"></i>
              <span class="animate-target">Back to settings</span>
            </a>
          </div>
          <p class="fs-sm pb-1">To apply the provided styles to your webpage, enclose them within a <code>&lt;style&gt;</code> tag and insert this tag into the <code>&lt;head&gt;</code> section of your HTML document after the following link to the main stylesheet:<br><code>&lt;link href="{{ asset('client/template') }}/assets/css/theme.min.css"&gt;</code></p>
    ...
    <form method="POST" action="{{ route('password.email') }}">
        ...
        <div class="flex items-center justify-end mt-4">
          ...
          <footer class="mt-auto">
            <div class="nav mb-4">
              <a class="nav-link text-decoration-underline p-0" href="{{ asset('client/template') }}/help-topics-v1.html">Need help?</a>
            </div>
            <p class="fs-xs mb-0">
              © All rights reserved. Made by <span class="animate-underline"><a class="animate-target text-dark-emphasis text-decoration-none" href="{{ asset('client/template') }}/https://createx.studio/" target="_blank" rel="noreferrer">Createx Studio</a></span>
            </p>
          </footer>
        </div>
        ...
        <div class="d-none d-lg-block w-100 py-4 ms-auto" style="max-width: 1034px">
          <div class="d-flex flex-column justify-content-end h-100 rounded-5 overflow-hidden">
            ...
            <div class="ratio position-relative z-2" style="--cz-aspect-ratio: calc(1030 / 1032 * 100%)">
              <img src="{{ asset('client/template') }}/assets/img/account-cover.png" alt="Girl">
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="floating-buttons position-fixed top-50 end-0 z-sticky me-3 me-xl-4 pb-4">
      <a class="btn btn-sm btn-outline-secondary text-uppercase bg-body rounded-pill shadow animate-rotate ms-2 me-n5" href="{{ asset('client/template') }}/#customizer" style="font-size: .625rem; letter-spacing: .05rem;" data-bs-toggle="offcanvas" role="button" aria-controls="customizer">
